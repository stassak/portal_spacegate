...
public class SkyLiftEnemy : MonoBehaviour
{
    ...
    void Start()
    {
        InvokeRepeating("SpawnRandomAsteriod", 2.0f, 15.0f);
    }
    ...
    void SpawnRandomAsteriod()
    {
        ...
        Vector3 spawnPos = new Vector3(Random.Range(-150 , 100),Random.Range(-100, 100),-1100);//  y spawn point : Random.Range(-100, 0) for z: 1200
