...
public class SpawnStarShipEnemyPoint : MonoBehaviour
{
    ...
    void Start()
    {
        InvokeRepeating("SpawnRandomAsteriod", 2f, Random.Range(10f,20f));
    }
    ...
    void SpawnRandomAsteriod()
    {
        ...
        Vector3 spawnPos = new Vector3(Random.Range(-80, 300), Random.Range(-100, 0), 1200);//  y spawn point : Random.Range(-100, 0) for z: 1200
